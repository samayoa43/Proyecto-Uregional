...
$stmt = $conexion->prepare("
    SELECT a.nombres, a.apellidos, u.correo 
...
<head>
    ...
    <style>
        ...
        /* Uso de variables genéricas o fallback azul para el botón */
        .btn-submit { width: 100%; padding: 12px; background: var(--color-primario, #0d6efd); color: white; border: none; border-radius: 8px; font-weight: bold; cursor: pointer; transition: opacity 0.3s; }
        .btn-submit:hover { opacity: 0.9; }

        /* Adaptación automática al modo oscuro (si lo utiliza tu script administrativo) */
...
<body>
    ...
    <script>
        // Lógica de modo oscuro si está habilitada en el lado administrativo
    ...
    <main class="main-container">
        ...
        <div class="kpi-card" style="border-top: 4px solid var(--color-primario, #0d6efd);">
            <div class="form-perfil">
                <form action="../procesar_perfil.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <span class="nota-pass">Si necesitas cambiar tu nombre legal, contacta a soporte técnico.</span>
                    </div>
